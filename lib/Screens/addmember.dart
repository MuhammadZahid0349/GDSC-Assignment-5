...
class _AddStudentPageState extends State<AddStudentPage> {
  ...
  final NadraController = TextEditingController();
  ...
  List<String> statusList = ['Male', 'Female'];
            ...
            children: [
              ...
              Container(
                  ...
                  child: CustomizedTextfield(
                    myController: NadraController,
                    hintText: 'Nadra Office',
                  )),
                  ...
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      setState(() {
                        ...
                        nadra = NadraController.text.trim();

                        CollectionReference members =
                            FirebaseFirestore.instance.collection(nadra);

                        addUser(
                            members, name, cnic, number, selectedType, date);
